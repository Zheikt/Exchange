    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                exchangeOutput = 0/*monitor.[methodName](methodParameters)*/;
            ...
            Console.WriteLine("Total exchanges performed: "/*Insert +  monitor.[propertyName]*/);
            Console.WriteLine("Total currency exchanged: "/*Insert + monitor.[propertyName].ToString("C")*/ + "USD");
            Console.ReadLine();
        }
    }
}
